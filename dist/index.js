...
module.exports = AutoLaunch = (function() {
  ...
  function AutoLaunch(arg) {
    var isHidden, mac, name, onlyMe, path, versions;
    name = arg.name, isHidden = arg.isHidden, mac = arg.mac, path = arg.path, onlyMe = arg.onlyMe;
    ...
    this.opts = {
      ...
      mac: mac != null ? mac : {},
      onlyMe: typeof onlyMe === "function" ? onlyMe(true) : void 0
    };
  ...
  AutoLaunch.prototype.disable = function() {
    return this.api.disable(this.opts.appName, this.opts.mac, this.opts.onlyMe);
  };

  AutoLaunch.prototype.isEnabled = function() {
    return this.api.isEnabled(this.opts.appName, this.opts.mac, this.opts.onlyMe);
  };
