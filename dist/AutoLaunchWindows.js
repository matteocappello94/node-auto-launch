...
module.exports = {
  ...
  /* Public */
  enable: function(arg) {
    var appName, appPath, isHiddenOnLaunch, onlyMe;
    appName = arg.appName, appPath = arg.appPath, isHiddenOnLaunch = arg.isHiddenOnLaunch, onlyMe = arg.onlyMe;
    if (!onlyMe) {
  ...
  disable: function(appName, onlyMe) {
    if (!onlyMe) {
      regKey.hive = Winreg.HKLM;
    }
    return new Promise(function(resolve, reject) {
  ...
  isEnabled: function(appName, mac, onlyMe) {
    if (!onlyMe) {
      regKey.hive = Winreg.HKLM;
    }
    return new Promise(function(resolve, reject) {
